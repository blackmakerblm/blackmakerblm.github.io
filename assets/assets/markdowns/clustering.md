...
![](assets/images/clustering/population_orange.png)

Essayons donc de visualiser pour chaque valeur de K le résultat de clusterisation

**k=4**
![](assets/images/clustering/populationk4.png)
...
![](assets/images/clustering/population_distribution.png)
...
**k=6**
![](assets/images/clustering/populationk6.png)
...
**k=8**
![](assets/images/clustering/populationk8.png)
on peut aussi voir ça dans le graphique de distribution par cluster.

**K=10**
![](assets/images/clustering/populationk10.png)
...
![](assets/images/clustering/population_frequence.png)
...
![](assets/images/clustering/superficie_orange.png)
...
**K=4**
![](assets/images/clustering/superficiek4.png)
...
**K=6**
![](assets/images/clustering/superficiek6.png)
**k=8**
![](assets/images/clustering/superficiek8.png)
...
**K=10**
![](assets/images/clustering/superficiek10.png)
# Interprétation
...
Ci dessous le schéma sous orange
![](assets/images/clustering/densitepopulation_orange.png)
On va juste mettre les captures d’écrans de k=4,6,8 en raison de la plus grande pertinence du K=10

**k=4**
![](assets/images/clustering/densitepopulationk4.png)
**K=6**
![](assets/images/clustering/densitepopulationk6.png)
**k=8**
![](assets/images/clustering/densitepopulationk8.png)
**k=10**
![](assets/images/clustering/densitepopulationk10.png)
...
![](assets/images/clustering/densitepopulation_interpretation.png)
**A.1.4) Produit Intérieur Brut pour K=4, K=6, K=8 et K=10**

Ci dessous le schéma sous Orange
![](assets/images/clustering/pib_orange.png)
...
**k=4**
![](assets/images/clustering/pibk4.png)

**k=6**
![](assets/images/clustering/pibk6.png)

**k=8**
![](assets/images/clustering/pibk8.png)

**k=10**
![](assets/images/clustering/pibk10.png)
# Interprétation
...
Ci dessous le schéma sous orange
![](assets/images/clustering/pibhabitant_orange.png)
...
**k=4**
![](assets/images/clustering/pibhabitantk4.png)

**k=6**
![](assets/images/clustering/pibhabitantk6.png)

**k=8**
![](assets/images/clustering/pibhabitantk8.png)

**k=10**
![](assets/images/clustering/pibhabitantk10.png)
# Interprétation
...
Ci dessous le schéma sous orange
![](assets/images/clustering/TCPIB_orange.png)
Les images ci dessous représentent respectivement la clustérisation avec k=4,6,8 par rapport au taux croissance du pib.
![](assets/images/clustering/TCPIBk4.png)
![](assets/images/clustering/TCPIBk6.png)
![](assets/images/clustering/TCPIBk8.png)
** K=10**
![](assets/images/clustering/TCPIBk10.png)
# Interprétation
...
Ci dessous le schéma sous Orange
![](assets/images/clustering/clusterisationgl_orange.png)
...
**k=4**
![](assets/images/clustering/clusterisationglk4.png)
...
**K=6**
![](assets/images/clustering/clusterisationglk6.png)

**k=8**
![](assets/images/clustering/clusterisationglk8.png)

**k=10**
![](assets/images/clustering/clusterisationglk10.png)
# Interprétation
...
![](assets/images/clustering/boitemoustache.png)
